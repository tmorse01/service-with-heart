/**
 * Shared testimonials list for Home page preview and Testimonials page.
 */
...
/** Names of testimonials to show on the home page preview. */
const FEATURED_NAMES = ["Susan M.", "Flora L."];

export const featuredTestimonials = testimonials.filter((t) =>
  FEATURED_NAMES.includes(t.name)
);
